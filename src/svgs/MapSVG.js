...
class MapSVG extends Component {
  constructor(props) {
    ...
    this.setMatadorsRef = element => {
      this.matadors = element
    }

    this.setCircleKRef = element => {
      this.circleK = element
    }

    this.setEasterBysRef = element => {
      this.easterbys = element
    }

    this.setTTFRef = element => {
      this.ttf = element
    }
  }

  componentDidMount() {
    TweenMax.to([this.circleK, this.matadors, this.easterbys], 1, {
